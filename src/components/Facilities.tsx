  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-9xl px-6 lg:px-8">
        <div className="mx-auto flex items-center max-w-4xl flex-col gap-16 bg-zinc-900 px-6 shadow-gray-950 shadow-lg rounded-3xl p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center  xl:gap-x-20 ">
          <Carousel />
          <div className="w-full flex-auto">
            ...
            <ul
              role="list"
              className="mt-10 grid grid-cols-1 gap-x-8 gap-y-3   text-zinc-400 sm:grid-cols-2"
            >
